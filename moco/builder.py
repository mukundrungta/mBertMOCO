...
from transformers import BertForPreTraining, BertTokenizer, BertForSequenceClassification
...
class MoCo(nn.Module):
    ...
    def __init__(self, dim=300, K=65536, m=0.999, T=0.07, mlp=False):
        ...
        self.encoder_k = BertForSequenceClassification.from_pretrained(
            ...
            cache_dir='/home/fanghongchao/.pytorch_pretrained_bert/distributed_-1',
            num_labels=2)
        # self.encoder_q = BertForPreTraining.from_pretrained('bert-base-multilingual-cased')
        # self.encoder_k = BertForPreTraining.from_pretrained('bert-base-multilingual-cased')
